...
public class CriarMROCommand {
    ...
    public CriarMROCommand(String nome, String descricao, TipoMRO tipo, Integer quantidadeEstoque, BigDecimal precoUnitario) {
        validate(nome, tipo, quantidadeEstoque, precoUnitario);
    ...
    private void validate(String nome, TipoMRO tipo, Integer quantidadeEstoque, BigDecimal precoUnitario) {
