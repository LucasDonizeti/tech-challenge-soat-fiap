...
import com.techchallenge.oficina.administrativo.application.usecases.ports.input.BuscarVeiculoInput;
...
@Slf4j
public class BuscarVeiculoUseCase implements BuscarVeiculoInput {
    ...
    public VeiculoResponse execute(UUID veiculoId) {
        ...
        return veiculoGateway.findById(veiculoId)
                .map(veiculo -> {
