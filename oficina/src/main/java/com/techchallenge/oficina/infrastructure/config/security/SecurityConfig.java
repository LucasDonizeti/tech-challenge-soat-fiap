...
import com.techchallenge.oficina.sharedkernel.infrastructure.security.ClienteUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/v1/admin/health", "/v1/os/health").permitAll()
                .requestMatchers("/actuator/**").permitAll()
                .requestMatchers("/error").permitAll()
                .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").permitAll()

                // Rotas de cliente — exigem token JWT com ROLE_CLIENTE
                .requestMatchers("/api/cliente/**").hasRole("CLIENTE")

                // Rotas de OS (gestão interna) — exigem token JWT com ROLE_ADMIN
                .requestMatchers("/v1/os/**").hasRole("ADMIN")
