...
@DisplayName("Testes de ClienteReativadoEvent - Domain Layer")
class ClienteReativadoEventTest {
    ...
    void deveCriarEventoComIdCliente() {
        ...
        // Act
        ClienteReativadoEvent event = new ClienteReativadoEvent(clienteId);
